...
class DBHelper {
  ...
  //  insert categories
    ...
    await db.execute("INSERT INTO $_tableName (title, img, time, repeat, category, description, video) VALUES (?, ?, ?, ?, ?, ?, ?)",
        ['elevations-laterales', 'assets/musculation/epaules/elevations-laterales.jpg', 10, 12, 5, "Il sollicite le grand droit des abdominaux en statique, le droit antérieur et le psoas iliaque. Le grand droit fait partie de la sangle abdominale avec les obliques et le transverse. L’action du grand droit est la flexion du tronc.", 'https://www.youtube.com/watch?v=UYfuax8KwcE&t=2s']);
    await db.execute("INSERT INTO $_tableName (title, img, time, repeat, category, description, video) VALUES (?, ?, ?, ?, ?, ?, ?)",
